    ...
    <div>
        <div className="flex flex-col items-center justify-center h-screen bg-gray-50 text-gray-800">
            ...
            <div className="mt-2 p-5 text-xl">
                ...
                <span>|</span>
                <a href="https://www.instagram.com/deeo_ramoc" className="text-blue-600 hover:underline mx-2">Explore our Blog</a>
                <span>|</span>
                <a href="https://x.com/deeo_ramoc" className="text-blue-600 hover:underline mx-2">Join our Community</a>
            </div>
        </div>
    </div>
  )
